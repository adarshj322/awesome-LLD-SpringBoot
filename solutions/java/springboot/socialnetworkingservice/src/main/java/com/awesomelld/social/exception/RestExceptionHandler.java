...
import com.awesomelld.social.dto.ApiErrorResponse;
...
public class RestExceptionHandler {
    ...
    ResponseEntity<ApiErrorResponse> handleInvalid(InvalidStateException ex, ServletWebRequest request) {
    ...
    ResponseEntity<ApiErrorResponse> handleDomain(SocialException ex, ServletWebRequest request) {
        return build(HttpStatus.BAD_REQUEST, ex.getMessage(), request);
    }
