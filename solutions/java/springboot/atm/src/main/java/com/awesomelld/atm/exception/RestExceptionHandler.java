...
import com.awesomelld.atm.dto.ApiErrorResponse;
...
public class RestExceptionHandler {
    ...
    @ExceptionHandler({InvalidSessionException.class, InsufficientFundsException.class})
    ...
    ResponseEntity<ApiErrorResponse> handleDomain(AtmException ex, ServletWebRequest request) {
        return build(HttpStatus.BAD_REQUEST, ex.getMessage(), request);
    }
